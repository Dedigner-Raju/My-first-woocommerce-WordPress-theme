          ...
          <div class="sidebar-block">
            ...
            <div class="sidebar-box sidebar-item"> <span class="opener plus"></span>
              ...
              <div class="sidebar-contant">
                <ul>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="<?php echo THEME_URI; ?>/asset/images/products/item-small-1.jpg"></a> </div>
                    <div class="pro-detail-info"> <a>Summer Women Nice Cloth</a>
                      <div class="price-box"> <span class="price">$80.00</span> </div>
                    </div>
                  </li>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="<?php echo THEME_URI; ?>/asset/images/products/item-small-2.jpg"></a> </div>
                    <div class="pro-detail-info"> <a>Summer Women Nice Cloth</a>
                      <div class="price-box"> <span class="price">$80.00</span> </div>
                    </div>
                  </li>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="<?php echo THEME_URI; ?>/asset/images/products/item-small-3.jpg"></a> </div>
                    <div class="pro-detail-info"> <a>Summer Women Nice Cloth</a>
                      <div class="price-box"> <span class="price">$80.00</span> </div>
                    </div>
                  </li>
